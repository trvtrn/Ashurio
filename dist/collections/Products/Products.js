    ...
    hooks: {
        ...
        beforeChange: [
            ...
            function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var data, createdProuct, updated, data, updatedProduct, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            createdProuct = _a.sent();
                            updated = __assign(__assign({}, data), { stripeId: createdProuct.id, priceId: createdProuct.default_price });
